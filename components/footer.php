<footer>
    <div class="container">
        ...
        <a class="tsm-btn mb-5 mb-5" href="contact.php#project">
            <div class="tsm-btn-box center">Start a Project</div>
        </a>
        <div class="row justify-content-center footer">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                <h3>Email us at</h3>
                <h2>info@thesimple.marketing</h2>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5">
                <h3>Call us on</h3>
                <h2>+91-8427890955</h2>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.7/plugins/debug.addIndicators.min.js"
    integrity="sha512-Ey+nIg+Ue8gUAaCNjR1KHR8nwDjWn9QXoQbynR/X+V66s6u1oqynnuRQ8zSgg5f5gBNb2Bzsu1pItCi3sPkbfA=="
    crossorigin="anonymous"></script>
